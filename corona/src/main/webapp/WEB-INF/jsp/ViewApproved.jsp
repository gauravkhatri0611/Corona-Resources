...
<!--<c:url var="logoutUrl" value="/j_spring_security_logout" />
  ...
  <h3 class="heading">Approved Data </h3>
    <br><br>
            ...
            <tbody>
                <tr>
                    ...
                    <td width="60">${resources.pno}</td>
          			...
          			<td width="60"><a href="edit2${resources.address}"><img id=delete src="resources/img/update.png" alt=""></a></td>
                    <td width="60"><a href="decline2${resources.address}" onclick="return confirm('Are you sure you want to decline this item?');"><img id=delete src="resources/img/decline.png" alt=""></a></td>
